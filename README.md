...
[causality.ipynb](https://github.com/opendr-io/causality/blob/main/causality.ipynb): a Jupyter notebook for processing vuln data and adding ratings generated by the CAUSALITY model. Note: this does not require running a model or shipping your vuln data anywhere. The published ratings are loaded from text files which are in this repo. The model is not open sourced at this time.
