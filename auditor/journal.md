...
June 23: CVE-2026-34910 was added to the CISA KEV. It was predicted on June 1.
...
June 23: CVE-2025-12352 was added to the VulnCheck KEV. It was predicted It was predicted in December 2025.
...
June 12: CVE-2026-25939 was added to the VulnCheck KEV. It was predicted on April 25.
...
May 10: CVE-2025-40600 was added to the VulnCheck KEV. It was predicted December 2, 2025.
...
April 24: CVE-2024-57728 was added to the CISA KEV. It was predicted in May 2025.

April 23: CVE-2025-49867 was added to the VulnCheck KEV. It was predicted in December.
...
April 22: CVE-2024-32114 was added to the VulnCheck KEV. It was predicted in May 2025.
...
April 21: CVE-205-29635 was added to the VulnCheck KEV. It was predicted in May 2025.
...
April 9: CVE-2025-43532 was added to the VulnCheck KEV. It was predicted in March.
...
Feb 20: CVE-2024-6250 was added to the VulnCheck KEV. It was predicted in the first run in January 2025. Eigth lead time over one year.

Feb 20: CVE-2025-68461 was added to the VulnCheck KEV. It was predicted in the January 2026 run. 

Feb 20: CVE-2025-14528 was added to the VulnCheck KEV. It was predicted in the January 2026 run. 

Feb 17: CVE-2025-54068 was added to the VulnCheck KEV. It was predicted in December 2025. 
...
Feb 12: CVE-2025-40536 was added to both KEVs. It was predicted in the January 31, 2025 run.
...
Feb 11: CVE-2024-56159 was added to the VulnCheck KEV. It was predicted in May 2025. 
...
Feb 4: CVE-2025-14586 was added to the VulnCheck KEV. It was predicted in the January 31 run.

Feb 3: CVE-2025-64328 was added to the CISA KEV. It was predicted in the December 3, 2025 run.
...
Feb 2: CVE-2025-4396 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.

Feb 2: CVE-2025-1743 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.
...
January 30: CVE-2025-21756 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.

January 31: CVE-2025-10211 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.

January 29: CVE-2025-61155 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.

January 27: CVE-2025-64328 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.
...
January 23: CVE-2025-2081 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.

January 22: CVE-2025-54313 was added to the CISA KEV. It was predicted in the August 2025 run.

January 22: CVE-2025-31125 was added to the CISA KEV. It was predicted in the December 3, 2025 run.

January 22: CVE-2025-34026 was added to the CISA KEV. It was predicted in the December 3, 2025 run.

January 22: CVE-2025-7544 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.

January 22: CVE-2025-6485 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.

January 22: CVE-2025-8829 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.

January 22: CVE-2025-7407 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.
...
January 20: CVE-2025-0626 was added to the VulnCheck KEV. It was predicted in the December 3, 2025 run.
...
January 16: CVE-2025-52665 was added to the VulnCheck KEV. It was predicted in the December 3 run.

January 14: CVE-2024-2863 was added to the VulnCheck KEV. It was predicted in the January 2024 runs.
...
December 23: CVE-2025-49544 was added to the VulnCheck KEV. It was predicted in the December 3 run.
...
```CVE-2025-9491,PUBLISHED,zdi,2025-08-26T16:25:15.179Z,Microsoft Windows LNK File UI Misrepresentation Remote Code Execution Vulnerability,"Microsoft Windows LNK File UI Misrepresentation Remote Code Execution Vulnerability. This vulnerability allows remote attackers to execute arbitrary code on affected installations of Microsoft Windows. User interaction is required to exploit this vulnerability in that the target must visit a malicious page or open a malicious file. The specific flaw exists within the handling of .LNK files. Crafted data in an .LNK file can cause hazardous content in the file to be invisible to a user who inspects the file via the Windows-provided user interface. An attacker can leverage this vulnerability to execute code in the context of the current user. Was ZDI-CAN-25373.",MICROSOFT,Windows,hot```
...
```CVE-2025-24477,PUBLISHED,fortinet,2025-07-15T08:14:41.283Z,,"A heap-based buffer overflow in Fortinet FortiOS versions 7.6.0 through 7.6.2, 7.4.0 through 7.4.7, 7.2.4 through 7.2.11 allows an attacker to escalate its privileges via a specially crafted CLI command",FORTINET,FortiOS,warm```
...
October 19: CVE-2025-24912 was added to the VulncHECK KEV. It was predicted in the August run.

```3987	CVE-2025-24912	jpcert	2025-03-12T04:43:54.870Z		"hostapd fails to process crafted RADIUS packets properly. When hostapd authenticates wi-fi devices with RADIUS authentication, an attacker in the position between the hostapd and the RADIUS server may inject crafted RADIUS packets and force RADIUS authentications to fail."	JOUNI MALINEN	hostapd	2.11 and earlier	warm```
...
October 10: CVE-2025-22905 was added to the VulncHECK KEV. It was predicted in the February run.
...
September 11: 2025-5086 was added to the KEV and ENISA watchlists. It was predicted in the August run.
