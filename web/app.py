# streamlit_app.py — Dual-source CVE search (SQLite FTS5), RAM-served, no auto-results, fixed logo, no pagination.
#
...
st.set_page_config(page_title="CVE Ratings Search",layout="wide")
...
st.info("Ratings are available for January - August 2025 and all of 2024. " \
"CVEs published after Sep 1 are not yet rated. " \
"Years prior to 2024 have not been rated. " \
"A null result means the CVE was not rated hot or warm." \
"Type a full-text query, an exact CVE like `CVE-2024-12345`, or prefix vendor/product filters to get started.")
#st.info("Type a full-text query, an exact CVE like `CVE-2024-12345`, or prefix vendor/product filters to get started.")


# -------- Sidebar (paths & maintenance) --------
with st.sidebar:
...
# Map scoped fields in the query string
...
if st.sidebar.checkbox("Explain query plan (both)", value=False, key="explain_both"):
